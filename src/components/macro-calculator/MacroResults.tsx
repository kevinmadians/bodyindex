          ...
          <Button 
            ...
            onClick={() => {
              navigator.clipboard.writeText(
                `My daily macro targets: ${result.calories} calories, ${result.protein}g protein (${result.proteinPercentage}%), ${result.carbs}g carbs (${result.carbsPercentage}%), ${result.fat}g fat (${result.fatPercentage}%). Check your own at https://bodyindex.net`
              );
